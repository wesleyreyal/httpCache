 ...
 */
final class Version20230418141301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE configuration (id INT NOT NULL, domain_id INT NOT NULL, zone VARCHAR(100) NOT NULL, configuration VARCHAR(255) NOT NULL, ip VARCHAR(39) NOT NULL, PRIMARY KEY(id))');
