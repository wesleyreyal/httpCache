...
const About: NextPage = () => (
  <article className="prose m-auto mt-12">
    ...
    <p>
      En utilisant ce site, vous indiquez que vous avez lu et compris les conditions d’utilisation et que vous acceptez
      de les respecter en tout temps.
    </p>
    ...
    />
    <p>
      Nous nous réservons le droit de suspendre ou de résilier votre compte si vous utilisez notre site illégalement ou
      si vous violez les conditions d’utilisation acceptable.
    </p>
    ...
    <List items={['Gestion de cache HTTP']} />
    <p>
      Les services liés à ce document sont les services qui sont affichés sur notre site au moment où vous y accédez.
      Toutes les informations, descriptions ou images que nous fournissons sur nos services sont décrites et présentées
      ...
      fournissons. Vous acceptez d’acheter ces services à vos propres risques.
    </p>
    <h3>Paiements</h3>
    <p>Nous acceptons les modes de paiement suivants sur ce site :</p>
    <List items={['Carte Bancaire']} />
    <p>
      ...
      détails de paiement, vous confirmez que vous nous autorisez à facturer le montant dû à cet instrument de paiement.
    </p>
    <p>
      Si nous estimons que votre paiement a violé une loi ou l’une de nos conditions d’utilisation, nous nous réservons
      le droit d’annuler votre transaction.
    </p>
    <h4>Services</h4>
    <p>Les services seront facturés en totalité à la commande du service.</p>
    <h4>Abonnements</h4>
    <p>
      Tous nos abonnements récurrents seront automatiquement facturés et renouvelés jusqu’à ce que nous recevions d’avis
      que vous souhaitez annuler l’abonnement.
    </p>
    <h3>Limitation de responsabilité</h3>
    <p>
      Sylvain COMBRAQUE ou l’un de ses employés sera tenu responsable de tout problème découlant de ce site. Néanmoins,
      Sylvain COMBRAQUE et ses employés ne seront pas tenus responsables de tout problème découlant de toute utilisation
      irrégulière de ce site.
    </p>
    <h3>Indemnité</h3>
    <p>
      En tant qu’utilisateur, vous indemnisez par les présentes Sylvain COMBRAQUE de toute responsabilité, de tout coût,
    ...
    <h3>Divisibilité</h3>
    <p>
      Si, à tout moment, l’une des dispositions énoncées dans le présent document est jugée incompatible ou invalide en
      vertu des lois applicables, ces dispositions seront considérées comme nulles et seront retirées du présent
      document. Toutes les autres dispositions ne seront pas touchées par les lois et le reste du document sera toujours
    ...
    <p>
      ...
      utilisateurs se comportent sur notre site. Nous recommandons à nos utilisateurs de vérifier ces conditions
    ...
    <p>
      Email :{' '}
      <Link href="mailto:jointure.miraculeux_08@icloud.com" className="text-primary">
